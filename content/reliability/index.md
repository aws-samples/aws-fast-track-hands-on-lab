...
## Continuous Reliability Hands On Labs

 * [Setup Autoscaling on AWS](https://catalog.us-east-1.prod.workshops.aws/workshops/f3a3e2bd-e1d5-49de-b8e6-dac361842e76/en-US/advanced-modules/network)
 * [Dependency Monitoring (1-5)](https://wellarchitectedlabs.com/operational-excellence/100_labs/100_dependency_monitoring/)


 > [!NOTE]
> **Congratulations!** You have compelted actionable tasks for reliability.Lets move onto the reliability challanges!


## Continuous Reliability Challenges

### Scenario 
* Currently your company is facing some performance problems and would like to some performance tunning. Head of IT has tasked you to perform load testing, simulating real-life based load conditions. This solution should also include a monitoring dashboard to visualise the load test and scaling activities. 

* [Perform Load testing on the application](https://aws.amazon.com/solutions/implementations/distributed-load-testing-on-aws/)
